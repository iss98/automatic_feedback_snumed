...
\end{split}
"""
st.markdown(latex_equation1, unsafe_allow_html=True)
st.write("**지식맵**")
st.write("지식맵 들어가는 곳")
st.write("**오개념**")
...
st.text("**2^4 times 2^2 = 2^3 times 2^3 = 16 times 4 = 8 times 8**  x = 1")
st.write("3. 이항오개념 : 등식의 성질을 이용하여 양변에 2^{3x}를 나눈 것인데 이항이라는 용어로 표현함")
st.text("\left { 2^6 right }^x = 2^3 times 2^{ 3x }  **이항**  2^{ 3x } = 2^3")
